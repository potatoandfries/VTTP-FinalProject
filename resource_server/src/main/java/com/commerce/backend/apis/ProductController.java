...
public class ProductController extends PublicApiController {
    ...
    @GetMapping(path = "/product/related/{url}")
    ...
    @GetMapping(path = "/product/recent")
    ...
    @GetMapping(path = "/product/mostselling")
    ...
    @GetMapping(path = "/product/interested")
